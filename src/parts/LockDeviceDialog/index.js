...
import styles from "./lock_device_dialog.module.scss";
import clsx from "clsx";

const LockDeviceDialog = ({ isOpen, onClose, onSubmit }) => {
    ...
    return (
        <div className={clsx(styles.dialogBackdrop, isExiting && styles.dialogBackdropExit)}>
            <div className={clsx(styles.dialog, isExiting ? styles.dialogExit : styles.dialogEnter)}>
                <label className={styles.title}>Khoá máy</label>
                {
                ...
                <div>
                    {
                        renderTextInputField(
                            "text",
                            "Thông điệp khoá",
                            "Nhập thông điệp khoá",
                            lockMessage,
                            (e) => setLockMessage(e.target.value),
                            false
                        )
                    }
                    <div className={styles.dialogActions}>
                        <button type="button" onClick={handleSubmit}>Khoá</button>
...
export default LockDeviceDialog;