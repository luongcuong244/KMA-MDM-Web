...
import styles from "./add_application_attribute_dialog.module.scss";
import clsx from "clsx";

const AddApplicationAttributeDialog = ({ isOpen, onClose, onSubmit, configuration }) => {
...
export default AddApplicationAttributeDialog;