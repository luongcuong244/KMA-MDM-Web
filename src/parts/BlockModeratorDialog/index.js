...
import styles from "./block_moderator.module.scss";
...
const BlockModeratorDialog = ({ setShowDialog, user, onSuccess }) => {
    ...
    const handleSubmit = (e) => {
        ...
        adminAccountManagementService.blockUser(
            { 
                userId: user.userId, 
                reason: reason.trim(), 
...
export default BlockModeratorDialog;